...
DR_VALUES = [ 1, 2, 5]
BOX_VALUES = [20, 28, 40, 57, 80, 113, 160, 226, 320]
SEED_VALUES = list(range(101, 111))
Num_Values = [256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536]
...
with open('D:/pythonhomework/timesrecord_withoutoutput.txt', 'r') as f:
    for line in f:
        match = re.search(
